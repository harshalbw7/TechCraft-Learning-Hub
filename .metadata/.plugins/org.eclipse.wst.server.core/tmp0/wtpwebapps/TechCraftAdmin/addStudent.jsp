    ...
    <body>
        ...
        <header>
            ...
            <div class="heading">
                ...
                <a href="addStudent.jsp" style="border-bottom: 2px solid #ffa200; margin-top: 10px; padding-bottom: 10px;">Add Student</a>
        	...
        	<div class="roadmap-heading"> <br>
        		...
        		<fieldset>
		            ...
		            <div class="add-student">
		                ...
		                <div class="add-form">
			                <h2 style="text-align: center; color: black">Add Student</h2>
			                <form id="register-user" action="AddStudent" method="post">
						    ...
						    <div style="display: flex; align-items: center; text-align: center; margin-left: 35px">
							    <div class="register-container">
							    	<input type="button" class="register" value="add student" id="signUpButton" onclick="registerClicked('registrationModal')" style="background-color: #ffa200; cursor: pointer;">
