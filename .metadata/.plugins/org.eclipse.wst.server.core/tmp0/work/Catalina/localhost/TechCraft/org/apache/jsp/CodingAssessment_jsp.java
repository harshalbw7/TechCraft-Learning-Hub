 ...
 * Generated at: 2024-05-16 03:35:17 UTC
...
import techcraft.model.CodingAssessmentChallenge;
import java.util.List;

public final class CodingAssessment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("techcraft.model.CodingAssessmentChallenge");
  }
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</span>\r\n");
      out.write("					            		<p style=\"width: 900px;\">");
      out.print( challenge.getDescription() );
      out.write("</p>\r\n");
      out.write("					            	</div>\r\n");
      out.write("					            	<span style=\"flex: 1;\"></span>\r\n");
      out.write("					            	\r\n");
      out.write("					            	<form action=\"codingAssessmentEditor.jsp\"> \r\n");
      ...
      out.write("\">\r\n");
      out.write("									    <input type=\"hidden\" name=\"functional\" value=\"");
      out.print( challenge.getFunctionDescription() );
      out.write("\">\r\n");
      out.write("									    <input type=\"hidden\" name=\"input-format\" value=\"");
      out.print( challenge.getInputFormat() );
      out.write("\">\r\n");
      out.write("									    <input type=\"hidden\" name=\"output-format\" value=\"");
      out.print( challenge.getOutputFormat() );
      out.write("\">\r\n");
      out.write("									    <input type=\"hidden\" name=\"input\" value=\"");
      out.print( challenge.getSampleInput() );
      out.write("\">\r\n");
      out.write("									    <input type=\"hidden\" name=\"output\" value=\"");
      out.print( challenge.getRequiredOutput() );
      out.write("\">\r\n");
      out.write("									    <input type=\"hidden\" name=\"explination\" value=\"");
      out.print( challenge.getExplanation() );
      out.write("\">\r\n");
      ...
      out.print( i );
      out.write("\" name=\"submit-button\">Solve Challenge</button>\r\n");
      out.write("									</form>\r\n");
      out.write("					            </div> \r\n");
      out.write("		        	");
      ...
      out.write("		            	<span>Note : Complete all the challenges before submitting the assessment !</span>\r\n");
      out.write("		            </form>  \r\n");
      out.write("		        </div> \r\n");
      out.write("        	</div>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("        	        <input type=\"button\" class=\"login\" style=\"background-color: #ffa200; border: none\" value=\"Yes\" onclick=\"submitAssessment()\">\r\n");
      out.write("                    <input type=\"button\" class=\"login\" style=\"background-color: #d2d2e0; border: none\" value=\"Cancel\" onclick=\"closeModal('confirmation')\">\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("         \r\n");
      ...
      out.write("		    var buttonNo = ");
      out.print( buttonNo );
      out.write(";\r\n");
      out.write("		    var result = \"");
      out.print( challengeOutput );
      out.write("\";\r\n");
      out.write("		    console.log(\"buttonNo = \" + (buttonNo+1));\r\n");
      out.write("		     \r\n");
      out.write("		    var counter = 0;\r\n");
      out.write("		    var correctAnswer = 0;\r\n");
      out.write("		    \r\n");
      out.write("		    var inputs = document.querySelectorAll('button[name=\"submit-button\"]'); \r\n");
      ...
      out.write("    		\r\n");
      out.write("		    if (!isNaN(buttonNo) && buttonNo >= 0) { \r\n");
      out.write("		    	\r\n");
      out.write("		        for (var i = 0; i < inputs.length; i++) {\r\n");
      out.write("		            if (i === buttonNo) {  \r\n");
      out.write("		                localStorage.setItem('challengeSolved' + i, true);\r\n");
      out.write("		                localStorage.setItem('challengeResult' + i, result);\r\n");
      out.write("		                console.log(\"Challenge \" + (i+1) + \" is solved !\");\r\n");
      out.write("		            }\r\n");
      out.write("		        } \r\n");
      out.write("		        for (var j = 0; j < inputs.length; j++) {\r\n");
      out.write("		            if (localStorage.getItem('challengeSolved' + j)) {\r\n");
      out.write("		            	counter++;\r\n");
      out.write("		            	const updateButton = document.getElementById(\"submitButton\"+j);\r\n");
      out.write("		            	updateButton.innerText = \"Challenge Solved\";\r\n");
      out.write("		            	updateButton.classList.add('submit-button-style');\r\n");
      out.write("		                console.log(\"Challenge \" + (j+1) + \" is marked as solved.\");\r\n");
      out.write("		            }\r\n");
      out.write("		            if (localStorage.getItem('challengeResult' + j) === \"Correct Answer\") {\r\n");
      out.write("		                correctAnswer++;\r\n");
      out.write("		            }\r\n");
      out.write("		        }\r\n");
      out.write("		    } \r\n");
      out.write("		    console.log(\"Total completeed challenges = \" + counter);\r\n");
      out.write("		    console.log(\"Total Correct Answers = \" + correctAnswer);\r\n");
      out.write("		    document.getElementById(\"correctAnswers\").value = correctAnswer;\r\n");
      out.write("		</script>\r\n");
      out.write("        \r\n");
      out.write("        <script type=\"text/javascript\">\r\n");
      ...
      out.write("        		\r\n");
      out.write("        		for (var i = 0; i < inputs.length; i++) {\r\n");
      out.write("        			localStorage.removeItem('challengeSolved' + i);\r\n");
      out.write("        			localStorage.removeItem('challengeResult' + i);\r\n");
      out.write("		        }\r\n");
      out.write("        		\r\n");
      ...
      out.write("		        \r\n");
      out.write("		        var inputs = document.querySelectorAll('button[name=\"submit-button\"]');\r\n");
      out.write("        		console.log(\"Number of buttons:\", inputs.length);\r\n");
      out.write("        		for (var i = 0; i < inputs.length; i++) {\r\n");
      out.write("        			localStorage.removeItem('challengeSolved' + i);\r\n");
      out.write("        			localStorage.removeItem('challengeResult' + i);\r\n");
      out.write("		        }\r\n");
