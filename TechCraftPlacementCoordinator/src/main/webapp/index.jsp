...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="placementIndex.css" type="text/css">
    ...
    <body>
        ...
        <header>
            ...
            <img src="./media/user.png" width=20px height=20px style="margin-right: 30px">
            <span>Placement Coordinator</span>
        </header>

        <div class="main">
            <img src="./media/software-engineer.svg">
            <div class="about">
                <h1>Welcome to TechCraft</h1>
                <div class="modal-content">
	                <h2 style="text-align: center; color: black">Coordinator Sign In</h2>
	                <form id="login-user" action="PlacementLogin" method="post">
        ...
        <div id="forgotPassword" class="modal-container">
            ...
            <div class="modal-content" style="margin: auto; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                ...
                <form id="forgot-password" action="PlacementForgotPassword" method="post">
